...
Distribution of averaged minimal relative errors for matched vibrational frequencies. The frequency analysis is both a stringent basis-set test and a filter for structures that converged to non-minimum stationary points.}
\end{figure}
