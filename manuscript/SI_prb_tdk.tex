...
\section{Additional pseudopotential-update diagnostic}
...
Direct comparison of the improved and original SIRIUS-GTH-UZH pseudopotential settings. This diagnostic shows where the pseudopotential update changes the equation-of-state curves and complements the residual basis-set, residual pseudopotential, and total-error maps in the main text.}
\end{figure}
