...
Residual error decomposition for the improved UZH settings. Left: residual CP2K Gaussian-basis error, obtained from CP2K-GTH-UZH-new relative to SIRIUS-GTH-UZH. Right: residual pseudopotential error, obtained from SIRIUS-GTH-UZH-new relative to SIRIUS-FP-LAPW.}
\end{figure*}
...
Total equation-of-state error of the improved CP2K-GTH-UZH-new settings relative to SIRIUS-FP-LAPW. This comparison combines the residual basis-set and pseudopotential contributions shown in Fig.~\ref{fig:improved_components}.}
\end{figure*}
