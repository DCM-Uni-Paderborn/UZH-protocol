...
\begin{figure*}
\includegraphics[width=\textwidth]{periodic-table-unaries-CP2K-UZH-vs-SIRIUS-LAPW-epsilon-notitle.png}
...
\begin{figure*}
\centering
\includegraphics[width=0.49\textwidth]{periodic-table-unaries-CP2K-UZH-new-vs-SIRIUS-UZH-new-epsilon-estimated-padded.png}\hfill
