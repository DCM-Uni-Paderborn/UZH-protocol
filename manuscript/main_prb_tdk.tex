...
\begin{table*}[htbp]
\centering
\caption{Structure-resolved $\varepsilon$ values for CP2K-GTH-UZH relative to SIRIUS-FP-LAPW for the elements recomputed after improvement. Each prototype reports the improved and original settings side by side; values below unity indicate substantially improved equation-of-state agreement on the verification scale used here.}
...
Element & \multicolumn{2}{c}{Diamond} & \multicolumn{2}{c}{FCC} & \multicolumn{2}{c}{BCC} & \multicolumn{2}{c}{SC} \\
 & improved & original & improved & original & improved & original & improved & original \\
\hline
He & 0.2258 & 0.7904 & 0.1744 & 0.2356 & 0.2122 & 0.2216 & 0.1665 & 0.5329 \\
Ne & 0.7737 & 1.4836 & 0.7406 & 1.7451 & 0.7519 & 1.7018 & 0.7450 & 1.5810 \\
Ar & 0.4301 & 1.3158 & 0.2498 & 1.6646 & 0.2650 & 1.5667 & 0.3211 & 1.4525 \\
Ca & 0.6364 & 1.0954 & 0.1080 & 1.1562 & 0.0705 & 1.3434 & 0.2018 & 1.7059 \\
Cr & 0.0333 & 1.0475 & 0.0598 & 1.2951 & 0.0628 & 1.3602 & 0.0157 & 1.2515 \\
Kr & 0.2758 & 1.7388 & 0.0375 & 1.8142 & 0.0337 & 1.7521 & 0.0429 & 1.8303 \\
Tc & 0.7302 & 1.0057 & 0.7530 & 0.9678 & 0.7458 & 0.9937 & 0.7055 & 0.9554 \\
Ru & 0.6156 & 1.6774 & 0.5594 & 1.5582 & 0.5823 & 1.5601 & 0.6050 & 1.6216 \\
Rh & 0.7382 & 1.6477 & 0.5017 & 1.5784 & 0.5258 & 1.5789 & 0.6071 & 1.5760 \\
Pd & 0.6413 & 1.6345 & 0.6186 & 1.4643 & 0.6604 & 1.4594 & 0.6105 & 1.5064 \\
Xe & 0.6154 & 0.9720 & 0.1580 & 1.3670 & 0.2052 & 1.3011 & 0.1723 & 0.9874 \\
Ba & 1.5912 & 1.8967 & 0.2134 & 0.9984 & 0.2399 & 0.9087 & 0.7621 & 1.4169 \\
Ir & 0.2984 & 1.5403 & 0.3439 & 1.2250 & 0.3148 & 1.1608 & 0.2879 & 1.2696 \\
Au & 0.2256 & 1.6294 & 0.4089 & 1.4091 & 0.3981 & 1.4188 & 0.3052 & 1.4754 \\
Rn & 1.2897 & 1.5540 & 0.7849 & 1.6896 & 0.8211 & 1.6271 & 0.7240 & 1.7891 \\
\hline
\end{tabular}
\end{table*}
...
Figure~\ref{fig:component_updates} reports the two optimized comparisons that define the remaining error components. The top panel compares CP2K-GTH-UZH-new with SIRIUS-GTH-UZH-new and therefore gives the residual Gaussian-basis contribution for the optimized settings. The bottom panel compares SIRIUS-GTH-UZH-new with SIRIUS-FP-LAPW and gives the residual pseudopotential contribution. At the level of the underlying signed equation-of-state energy differences, the superposition of the upper and lower comparisons corresponds to the remaining total CP2K-GTH-UZH-new error relative to SIRIUS-FP-LAPW shown in the bottom panel of Fig.~\ref{fig:total_before_after}; the positive $\varepsilon$ values themselves should therefore be interpreted as component norms rather than added element by element. Read together with the total-error reduction in Fig.~\ref{fig:total_before_after}, these maps show that the improvement is not a cosmetic redistribution of errors but a targeted reduction of the components identified as limiting. Supplemental Material Figs.~6--10 show representative equation-of-state curves for Cr, Ba, Ne, Au, and Ga, connecting the periodic-table heat-map colors to the underlying energy-volume data and showing how basis-limited, pseudopotential-limited, and mixed cases appear at the curve level.


\begin{figure*}
\includegraphics[width=\textwidth]{periodic-table-unaries-CP2K-UZH-new-vs-SIRIUS-UZH-new-epsilon.png}\\[0.5ex]
\includegraphics[width=\textwidth]{periodic-table-unaries-SIRIUS-UZH-new-vs-SIRIUS-LAPW-epsilon.png}
\caption{\label{fig:component_updates}
Residual error decomposition for the optimized UZH settings. Top: CP2K-GTH-UZH-new relative to SIRIUS-GTH-UZH-new, which isolates the remaining Gaussian-basis contribution. Bottom: SIRIUS-GTH-UZH-new relative to SIRIUS-FP-LAPW, which isolates the remaining pseudopotential contribution.}
\end{figure*}
...
The curated release repository for the UZH protocol is available at \url{https://github.com/DCM-Uni-Paderborn/UZH-protocol}. It contains the official CP2K UZH basis-set and pseudopotential files, organized CP2K-GTH-UZH, SIRIUS-GTH-UZH, and SIRIUS-FP-LAPW equation-of-state result files, per-element equation-of-state diagnostic plots, selected workflow input/output records, manuscript figures, source mappings, file inventories, and SHA-256 checksums. The molecular calibration data are connected to the MolTest Zenodo archive cited above, while the release repository records the periodic verification and parameter-file data used for the present comparison. Section V of the Supplemental Material gives the corresponding directory layout and identifies the remaining items that should be completed before final archival release.
% TDK comment: Still to complete for the final archival data release: raw molecular-calibration input/output tables beyond the cited MolTest Zenodo material, executable post-processing scripts for the epsilon maps, and final software-version metadata once the production workflow versions are fixed.
