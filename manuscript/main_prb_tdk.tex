...
\begin{figure*}
\includegraphics[width=0.49\textwidth]{periodic-table-unaries-CP2K-UZH-new-vs-SIRIUS-UZH-epsilon.png}\hfill
...
Component-update diagnostics for the improved UZH settings. Left: CP2K-side basis-set-update diagnostic, obtained from CP2K-GTH-UZH-new relative to the original SIRIUS-GTH-UZH reference. Right: direct pseudopotential-update diagnostic, obtained from SIRIUS-GTH-UZH-new relative to the original SIRIUS-GTH-UZH settings.}
\end{figure*}
