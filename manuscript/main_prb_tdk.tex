...
\begin{figure*}
\centering
\includegraphics[width=0.70\textwidth]{TM_mol_polarizabilities_highres.png}
...
Total equation-of-state error of the improved CP2K-GTH-UZH-new settings relative to SIRIUS-FP-LAPW. This comparison is the final production-level accuracy test and contains the remaining CP2K Gaussian-basis contribution together with the residual pseudopotential error shown in Fig.~\ref{fig:improved_pp}.}
\end{figure*}
