...
Figure~\ref{fig:molecular_angles} extends the same analysis beyond local bond distances. Nonlinear bond angles and dihedral angles are more sensitive than bond lengths to subtle changes in the electronic structure and to the automated matching of nearly symmetric structures, but the hierarchy of basis quality remains visible.

\begin{figure*}
\centering
\includegraphics[width=\textwidth]{TM_mol_2.png}
\caption{\label{fig:molecular_angles}
Molecular calibration of angular observables. The distributions show relative errors for nonlinear angles and dihedral angles. These quantities are more sensitive than bond lengths to automated atom matching and near-symmetric geometries, but they retain the same systematic basis-set trend.}
\end{figure*}
