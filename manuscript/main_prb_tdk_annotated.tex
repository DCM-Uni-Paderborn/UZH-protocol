...
\TDKout{The previous version summarized the residual component errors after applying the UZH protocol. The left panel gave an illustrative estimate of the residual CP2K Gaussian-basis contribution after improvement, constructed from the final total-error map and the residual pseudopotential map. This panel was therefore a diagnostic estimate rather than an independent CP2K-GTH-UZH-new versus SIRIUS-GTH-UZH-new equation-of-state comparison. The right panel directly measured the remaining pseudopotential transferability error by comparing SIRIUS-GTH-UZH-new with SIRIUS-FP-LAPW. Together with the total-error reduction in Fig.~\ref{fig:total_before_after}, these maps showed that the improvement is not a cosmetic redistribution of errors but a targeted reduction of the component identified as limiting. For completeness, the full pseudopotential before--after diagnostic was reported in the Supplemental Material.}\TDKin{Figure~\ref{fig:component_updates} summarizes the component updates introduced by the UZH protocol. The left panel is a CP2K-side diagnostic for the basis-set update, shown as CP2K-GTH-UZH-new relative to the original SIRIUS-GTH-UZH reference; because the revised CP2K branch also accompanies the updated parameter set, this map is used to show where the Gaussian-basis revision changes the equation-of-state metric rather than as an independent residual-error decomposition. The right panel is the direct SIRIUS-GTH-UZH-new versus SIRIUS-GTH-UZH comparison and therefore shows where the pseudopotential refit modifies the plane-wave equation-of-state curves. Together with the total-error reduction in Fig.~\ref{fig:total_before_after}, these maps show that the improvement is not a cosmetic redistribution of errors but a targeted reduction of the components identified as limiting. The residual component estimate and the full pseudopotential before--after diagnostic are reported in the Supplemental Material.}

\begin{figure}
\TDKout{Previous residual-component figure moved to the Supplemental Material.}\\[0.5ex]
\TDKin{\includegraphics[width=0.49\linewidth]{periodic-table-unaries-CP2K-UZH-new-vs-SIRIUS-UZH-epsilon.png}\hfill
\includegraphics[width=0.49\linewidth]{periodic-table-unaries-SIRIUS-UZH-new-vs-SIRIUS-UZH-epsilon.png}}
\caption{\label{fig:component_updates}
\TDKout{Residual component errors after applying the UZH protocol. Left: illustrative estimate of the residual CP2K Gaussian-basis contribution, constructed as the positive difference between the final CP2K-GTH-UZH-new total-error map and the residual pseudopotential map. Right: residual pseudopotential error for the improved SIRIUS-GTH-UZH-new settings relative to the SIRIUS-FP-LAPW reference.}\TDKin{Component-update diagnostics for the improved UZH settings. Left: CP2K-side basis-set-update diagnostic, obtained from CP2K-GTH-UZH-new relative to the original SIRIUS-GTH-UZH reference. Right: direct pseudopotential-update diagnostic, obtained from SIRIUS-GTH-UZH-new relative to the original SIRIUS-GTH-UZH settings.}}
\end{figure}
