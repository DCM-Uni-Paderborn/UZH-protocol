...
Figure~\ref{fig:component_updates} resolves the remaining error after optimization into residual component contributions. The top panel estimates the residual CP2K Gaussian-basis contribution by subtracting the residual pseudopotential map from the final CP2K-GTH-UZH-new total-error map and retaining the positive part. The bottom panel shows the residual pseudopotential error directly as SIRIUS-GTH-UZH-new relative to the SIRIUS-FP-LAPW reference. Read together with the total-error reduction in Fig.~\ref{fig:total_before_after}, these maps show that the improvement is not a cosmetic redistribution of errors but a targeted reduction of the components identified as limiting. The full pseudopotential before--after diagnostic and the direct pseudopotential-update map are reported in the Supplemental Material.
