...
\TDKout{Figure~\ref{fig:component_updates} resolves the remaining error after optimization into residual component contributions. The top panel shows the residual CP2K Gaussian-basis contribution by subtracting the residual pseudopotential map from the final CP2K-GTH-UZH-new total-error map and retaining the positive part. The bottom panel shows the residual pseudopotential error directly as SIRIUS-GTH-UZH-new relative to the SIRIUS-FP-LAPW reference.}\TDKin{Figure~\ref{fig:component_updates} summarizes the residual components of the optimized setup. The top panel represents the residual CP2K Gaussian-basis contribution associated with the optimized GTH-UZH-new setup, while the bottom panel gives the residual pseudopotential contribution relative to the SIRIUS-FP-LAPW reference.} Read together with the total-error reduction in Fig.~\ref{fig:total_before_after}, these maps show that the improvement is not a cosmetic redistribution of errors but a targeted reduction of the components identified as limiting. The full pseudopotential before--after diagnostic and the direct pseudopotential-update map are reported in the Supplemental Material.

\begin{figure*}
\includegraphics[width=\textwidth]{periodic-table-unaries-CP2K-UZH-new-vs-SIRIUS-UZH-new-epsilon-estimated-padded.png}\\[0.5ex]
...
Residual component diagnostics for the improved UZH settings. \TDKout{Top: residual CP2K Gaussian-basis contribution, constructed as the positive difference between the final CP2K-GTH-UZH-new total-error map and the residual pseudopotential map. Bottom: residual pseudopotential error for the improved SIRIUS-GTH-UZH-new settings relative to the SIRIUS-FP-LAPW reference.}\TDKin{Top: residual CP2K Gaussian-basis contribution associated with the optimized GTH-UZH-new setup. Bottom: residual pseudopotential contribution for the improved SIRIUS-GTH-UZH-new settings relative to the SIRIUS-FP-LAPW reference.}}
\end{figure*}
