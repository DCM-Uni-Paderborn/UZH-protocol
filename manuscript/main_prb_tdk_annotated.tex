...
\TDKout{Angular properties follow the same pattern.}\TDKin{Figures~\ref{fig:molecular_angles} and \ref{fig:molecular_dihedrals} extend the same analysis beyond local bond distances.} Nonlinear bond angles and dihedral angles are more sensitive than bond lengths to subtle changes in the electronic structure\TDKin{ and to the automated matching of nearly symmetric structures}, but the hierarchy of basis quality remains \TDKout{clear}\TDKin{visible}.

\begin{figure}
\centering
\includegraphics[width=\linewidth]{TM_mol_angles.png}
\caption{\label{fig:molecular_angles}
\TDKout{Molecular calibration of angular observables. The distributions show relative errors for nonlinear angles and dihedral angles. These quantities are more sensitive than bond lengths to automated atom matching and near-symmetric geometries, but they retain the same systematic basis-set trend.}\TDKin{Distribution of relative errors for nonlinear angles in the molecular calibration set. Angular observables are more sensitive than bond lengths to automated atom matching and near-symmetric geometries, but the systematic improvement from DZVP to TZV2P remains visible.}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{TM_mol_dihedrals.png}
\caption{\label{fig:molecular_dihedrals}
\TDKin{Distribution of relative errors for dihedral angles in the molecular calibration set. The broader tails reflect the stronger sensitivity of torsional coordinates to small structural and matching differences, while the basis-set hierarchy remains consistent with the bond-length and angle tests.}}
\end{figure}

\TDKout{The previous text referred to the combined response-property figure.}\TDKin{Figures~\ref{fig:molecular_dipoles} and \ref{fig:molecular_polarizabilities} show the corresponding response-property tests.} Dipole moments and polarizabilities provide a stronger test because they probe the response of the density rather than only the optimized geometry. The larger variance observed for polarizabilities is consistent with the need for diffuse flexibility, but the absence of catastrophic outliers at the TZV2P level indicates that the condition-number constraint in Eq.~(\ref{eq:molopt}) is effective.

\begin{figure}
\centering
\includegraphics[width=\linewidth]{TM_mol_dipoles.png}
\caption{\label{fig:molecular_dipoles}
\TDKout{Molecular calibration of response properties. The distributions show relative errors for dipole moments and average molecular polarizabilities. Response properties are more demanding than equilibrium bond lengths, but they retain the systematic basis-set improvement needed before transferring the basis to periodic verification.}\TDKin{Distribution of relative errors for molecular dipole moments. The statistics include converged structures with non-vanishing dipole moments and show that response-sensitive density properties retain the same systematic basis-set improvement observed for structural observables.}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{TM_mol_polarizabilities.png}
\caption{\label{fig:molecular_polarizabilities}
\TDKin{Distribution of relative errors for average molecular polarizabilities. Polarizabilities are the most demanding molecular response test in this set because they require sufficient diffuse flexibility; TPSS is omitted because this property was not available for meta-generalized-gradient calculations in CP2K.}}
\end{figure}

\TDKin{The combined molecular data therefore support two practical choices. First, DZVP is useful as an economical screening level, but it should not be interpreted as a converged basis for response-sensitive properties. Second, TZV2P provides a more balanced reference level for the UZH optimization loop because it improves both covalent and polar bonding motifs without introducing the numerical fragility that would compromise large periodic calculations. This balance between chemical flexibility and numerical stability is essential: the goal is not to make the largest possible Gaussian basis, but to construct a basis that can be improved systematically together with the corresponding GTH-UZH pseudopotential files.}
...
The authors gratefully acknowledge computing time on the high-performance computer Noctua2 at \TDKout{the National High-Performance Computing (NHR) Center Paderborn Center for Parallel Computing (PC2)}\TDKin{the Paderborn Center for Parallel Computing, a National High-Performance Computing (NHR) Center}. This center is jointly supported by the Federal Ministry of Research, Technology and Space and the state governments participating in the NHR joint funding program. Additional support from the CP2K, SIRIUS, and AiiDA developer communities is gratefully acknowledged.
\end{acknowledgments}
