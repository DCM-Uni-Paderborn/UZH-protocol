...
\begin{figure*}
\centering
\TDKout{Original one-column, low-resolution raster figure.}\\[0.5ex]
\TDKin{\includegraphics[width=0.70\textwidth]{TM_mol_polarizabilities_highres.png}}
\TDKcomment{Changed Fig.~3 to a two-column float and replaced the low-resolution raster with a cropped, upsampled, sharpened version.}
...
\begin{figure*}
\TDKout{\includegraphics[width=\textwidth]{periodic-table-unaries-CP2K-UZH-vs-SIRIUS-LAPW-epsilon.png}}
...
\includegraphics[width=0.49\textwidth]{periodic-table-unaries-SIRIUS-UZH-new-vs-SIRIUS-LAPW-epsilon-padded.png}}
\TDKcomment{Removed the panel letters and added top padding to both Fig.~6 raster files so that the upper structure boxes are no longer clipped.}
