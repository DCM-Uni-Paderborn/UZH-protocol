...
Let $E_{\mathrm{C}}^{\mathrm{GTH}}(V)$ denote CP2K-GTH-UZH energies, $E_{\mathrm{S}}^{\mathrm{GTH}}(V)$ SIRIUS-GTH-UZH energies, and $E_{\mathrm{S}}^{\mathrm{AE}}(V)$ SIRIUS-FP-LAPW all-electron (AE) energies for the same structure and volume, respectively. The total deviation of the practical CP2K protocol is
\begin{equation}
\Delta_{\mathrm{tot}}(V)=
