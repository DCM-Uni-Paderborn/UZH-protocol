...
\end{equation}
\TDKout{where $\kappa_B(M)$ is the condition number for basis level $B$ and molecule $M$.}\TDKin{where $M$ denotes the molecule.} The MOLOPT optimization target balances accuracy and numerical stability,
\begin{equation}
\Omega =
