...
Residual component diagnostics for the improved UZH settings. Top: residual CP2K Gaussian-basis contribution associated with the optimized GTH-UZH-new setup. Bottom: residual pseudopotential contribution for the improved SIRIUS-GTH-UZH-new settings relative to the SIRIUS-FP-LAPW reference.}
\end{figure*}
