...
\caption{\label{fig:improved_components}
\TDKout{Verification of the improved UZH settings. Top left: total CP2K-GTH-UZH-new error relative to SIRIUS-FP-LAPW. Top right: residual CP2K Gaussian-basis error. Bottom left: residual pseudopotential error after improvement. Bottom right: direct comparison of new and original SIRIUS-GTH-UZH pseudopotential settings.}\TDKin{Residual error decomposition for the improved UZH settings. Left: residual CP2K Gaussian-basis error, obtained from CP2K-GTH-UZH-new relative to SIRIUS-GTH-UZH. Right: residual pseudopotential error, obtained from SIRIUS-GTH-UZH-new relative to SIRIUS-FP-LAPW.}}
\end{figure*}
...
\TDKin{Total equation-of-state error of the improved CP2K-GTH-UZH-new settings relative to SIRIUS-FP-LAPW. This comparison combines the residual basis-set and pseudopotential contributions shown in Fig.~\ref{fig:improved_components}.}}
\end{figure*}
