...
\TDKout{The previous main text showed the nonlinear-angle and dihedral-angle distributions as separate figures.}\TDKin{Nonlinear bond angles and dihedral angles extend the same analysis beyond local bond distances.} They are more sensitive than bond lengths to subtle changes in the electronic structure\TDKin{ and to the automated matching of nearly symmetric structures}, but the hierarchy of basis quality remains \TDKout{clear}\TDKin{visible; the corresponding distributions are reported in the Supplemental Material}.
