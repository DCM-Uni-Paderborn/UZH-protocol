...
# global hardness which is associated with the stability of the molecule (etha) can be expressed as ? = 1 / 2(E LUMO ? E HOMO )
etha=$(echo "scale=8; 0.5*(($Elumo)-($Ehomo))" | bc -l);

# electronic chemical potential (?) in terms of electron affinity and ionization potential is given by ? = 1 / 2(E HOMO + E LUMO )

mu=$(echo "scale=8; 0.5*(($Elumo)+($Ehomo))" | bc -l);

# The global electrophilicity index, ? = (?^2) / 2?
...
#===============================================================================================================================================================
printf  "structure,Ehomo(eV),Elumo(eV),Eg,I,A,?,?,?\n"
